...
```{r, include=F}
setwd("C:\\Users\\HP\\Desktop\\Hermine\\Econometrics")
...
data<-read.csv("Data\\Trip_Advisor_Armenian_Hotels_without_na.csv")
...
#png(filename = "Plots//1_most_expensive.png", width=12+2/3, height=6+2/3, units="in", res=1200)
data %>%
...
#png(filename = "Plots//2_most_review_count.png", width=12+2/3, height=6+2/3, units="in", res=1200)
data %>%
...
#png(filename = "Plots//3_review_count_vs_price.png", width=12+2/3, height=6+2/3, units="in", res=1200)
ggplot(data, aes(Review_Count, Price_USD))+geom_point(color=colors[5], size=2, alpha=0.6)+
  scale_x_continuous(breaks = pretty_breaks(10))+
  scale_y_continuous(breaks = pretty_breaks(10))+
  labs(title="Relationship Between Price and Number of Reviews", y="Price (USD)",
       x="Number of Reviews")+theme_bw()
#dev.off()


#png(filename = "Plots//4_price_per_state_boxplot.png", width=12+2/3, height=6+2/3, units="in", res=1200)
...
#png(filename = "Plots//5_price_per_category.png", width=12+2/3, height=6+2/3, units="in", res=1200)
...
#png(filename = "Plots//6_dist_price.png", width=12+2/3, height=6+2/3, units="in", res=1200)
...
#png(filename = "Plots//7_photos_vs_reviews.png", width=12+2/3, height=6+2/3, units="in", res=1200)
ggplot(data, aes(y=Review_Count, x=Photos_Count))+geom_point(aes(color=State), size=4, alpha=0.8)+
  ...
  labs(title="Relationship Between Number of Photos and Number of Reviews", x="Number of Photos",
       y="Number of Reviews")+theme_bw()
#dev.off()


#png(filename = "Plots//8_score_vs_reviews_state.png", width=12+2/3, height=6+2/3, units="in", res=1200)
...
#png(filename = "Plots//9_score_vs_reviews_category.png", width=12+2/3, height=6+2/3, units="in", res=1200)
...
#png(filename = "Plots//10_avg_score_per_category.png", width=12+2/3, height=6+2/3, units="in", res=1200)
...
#png(filename = "Plots//11_price_per_score.png", width=12+2/3, height=6+2/3, units="in", res=1200)
ggplot(data, aes(x=Price_USD))+geom_histogram(bins=50, color=colors[5], fill=colors[7])+
